...
export default function Home(attr) {
  ...
  const [ locais, alteraLocais ] = useState([
    ...
    tipo_quadra: "Basquete",
    imagem_principal: "/imagens/campo_futebol_primeira.png",
    imagem_pri: "/imagens/campo_futebol_segunda.png",
    imagem_seg: "/imagens/campo_futebol_terceira.png",
    imagem_ter: "/imagens/campo_futebol_quarta.png",
    preco: 179,
